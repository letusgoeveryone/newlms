                ...
                <div class="col-sm-11 tab-content" id=" console-sections">
                    <div class="console-section tab-pane fade in active" id="nav_to_help">
                        ...
                        <ul id="tmp-guide">
                            ...
                            <li>
                                <div style="display:none;" id="sz_zs_js_div" >  <jsp:include page="acdemic/zs_js.jsp"/>
                                    <!--正式教师信息管理-->
                            </li>
                            <li>
                                <div style="display:none;" id="sz_zs_kc_div" >  <jsp:include page="acdemic/course.jsp"/>
                                    <!--正式教师信息管理-->
                            </li>
                            <li>
                                <div  style="display:none;" id="sz_zs_kc_all">   <jsp:include page="acdemic/set_all.jsp"/>
                                </div>
                            </li>
                        </ul>        
