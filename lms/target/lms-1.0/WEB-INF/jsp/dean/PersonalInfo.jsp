    ...
    <body style="background-color:rgba(0,0,0,0);" >
        ...
        <script>
            ...
            $(".saves").click(function(){
                ...
                $.post("<%=path%>/dean/resetpw_p", { pw: hex_md5($("#inputPassword1").val()), repw:hex_md5($("#inputPassword2").val()) },
                function(data){
             ...
             //修改个人信息
                 $("#update").click(function(){
                     $.post("<%=path%>/dean/update", {idCard:$("#idCard").val(), name:$("#name").val(), qq:$("#qq").val(), tel:$("#tel").val() },
                function(data){
                  
                    if(data=="0"){alert("ok,您的信息已经修改成功。");
