...
$("#ubox a[href^='#tab']").click(function(){
    $("#anchor-menu").click();
    $("#anchor-vstatus a[href= '" + $(this).attr("href") + "']").click();
});
function toggleUbox(){
    var ubox = $("#ubox")
    var header = $("header");
