...
public class Teacher  implements java.io.Serializable {
    ...
    public String toString() {
        return "Teacher{" + "teacherId=" + teacherId + ", teacherSn=" + teacherSn + ", teacherName=" + teacherName + ", teacherIdcard=" + teacherIdcard + ", teacherSex=" + teacherSex + ", teacherBirthday=" + teacherBirthday + ", teacherTel=" + teacherTel + ", teacherQq=" + teacherQq + ", teacherEmail=" + teacherEmail + ", teacherPwd=" + teacherPwd + ", teacherPositionId=" + teacherPositionId + ", teacherCollegeId=" + teacherCollegeId + ", teacherDepartId=" + teacherDepartId + ", teacherEnrolling=" + teacherEnrolling + ", teacherRoleValue=" + teacherRoleValue + '}';
    }
