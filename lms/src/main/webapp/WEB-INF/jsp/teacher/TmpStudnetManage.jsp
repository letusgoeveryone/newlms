...
<html>
    <head>
        <meta charset="UTF-8">
        <title>AccountRequstManage</title>
        <style>
            .easyui-linkbutton{
    ...
    <body>
        <div class="col-md-12" id="dg_stu_wrap">
            <div class="box-small text-orange">
                教师可在此处批准本班学生，不建议批准其他学生。
            </div>

            <div  id='xs_ls_xy' class="box-small">
            ...
            <table id="dg_stu" title="临时学生信息" class="table table-responsive width-control" style="width:100%;"
                   data-options="
                        rownumbers:true,
                        singleSelect:false,
                        pagination:true,
        ...
        <script>
            ...
            function getWidth(percent) { 
                //return document.body.clientWidth * percent ; 
                   return $("#dg_stu_wrap").css("width") * percent ;
            } 
