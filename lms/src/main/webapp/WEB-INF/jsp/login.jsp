...
<html>
    <head>
        ...
        <style media="screen">
            ...
            .form-control{border-bottom: 1px solid #FFF;}
        </style>
    </head>
...
<!--        <div id="lms_login_bg_f">
        ...
        <script>
            ...
            function postsubmit() {
                ...
                $.post("<%=path%>/logincheck", {username: $("#firstname").val(), password: hex_md5($("#password").val()), ccd: $("#checkcodeText").val()},
                        function (data) {
